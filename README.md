...
- Develop dashboard-style visualizations for stakeholders
- Build a complete data pipeline (CSV → Cleaning → Analysis → Visualization)
...
- `players.csv` – Player information (name, team, role)
